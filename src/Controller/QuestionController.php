...
class QuestionController extends AbstractController
{
    ...
    public function show(Request $request, QuestionRepository $questionRepository, EntityManagerInterface $em, int $id): Response
    {
    ...
    #[IsGranted('ROLE_USER')]
    public function ratingQuestion(Request $request, Question $question, int $score, EntityManagerInterface $em, VoteRepository $voteRepo): RedirectResponse
    {
        $user = $this->getUser();
